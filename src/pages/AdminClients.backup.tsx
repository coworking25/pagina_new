    ...
    <div className="relative" ref={dropdownRef}>
      ...
      <div className="min-h-[42px] border border-gray-200 dark:border-gray-600 rounded-lg p-2 bg-white dark:bg-gray-700">
        <div className="flex flex-wrap gap-1">
          ...
          >
            {selectedIds.length === 0 ? placeholder : 'Agregar mÃ¡s...'}
...
function AdminClients() {
  ...
  // Detectar si viene de una alerta y abrir automÃ¡ticamente el modal correspondiente
  useEffect(() => {
      ...
      const findClientWithAlert = async () => {
        try {
          ...
          if (state.highlightId) {
            ...
            // En una implementaciÃ³n mÃ¡s avanzada, podrÃ­amos filtrar por el cliente especÃ­fico
    ...
    try {
      ...
      if (!relation.contract_id) {
        try {
          ...
          console.log('âœ… Contrato creado automÃ¡ticamente:', createdContract);
        } catch (contractError) {
          console.error('âŒ Error creando contrato automÃ¡ticamente:', contractError);
          alert('Error al crear contrato automÃ¡ticamente. La relaciÃ³n no se actualizarÃ¡.');
          return;
        }
      }
  ...
  const handleBulkExport = () => {
    try {
      ...
      const headers = ['ID', 'Nombre', 'Email', 'TelÃ©fono', 'Tipo', 'Estado', 'Documento', 'DirecciÃ³n'];
...
Â¡Esperamos poder servirle pronto! ðŸ âœ¨`;
  ...
  const handleWizardSubmit = async (wizardData: any) => {
    try {
      console.log('ðŸ§™â€â™‚ï¸ Creando cliente desde Wizard:', wizardData);
      ...
      console.log('âœ… Cliente creado desde Wizard:', newClient);

      // 2. Crear credenciales del portal si se proporcionÃ³ contraseÃ±a
      if (wizardData.password) {
        try {
          ...
          console.error('âš ï¸ Error creando credenciales:', credError);
        }
      }
      ...
      if (wizardData.documents && wizardData.documents.length > 0) {
        for (const doc of wizardData.documents) {
          try {
            ...
            console.log(`âœ… Documento ${doc.type} subido`);
          } catch (docError) {
            console.error(`âš ï¸ Error subiendo documento ${doc.type}:`, docError);
          }
        }
      }
      ...
      if (wizardData.payment_concepts || wizardData.preferred_payment_method) {
        try {
          ...
          console.error('âš ï¸ Error guardando configuraciÃ³n de pagos:', paymentError);
        }
      }
      ...
      if (wizardData.personal_references || wizardData.commercial_references) {
        try {
          ...
          console.log(`âœ… Referencias guardadas (${totalRefs} referencias)`);
        } catch (refError) {
          console.error('âš ï¸ Error guardando referencias:', refError);
        }
      }
      ...
      if (wizardData.contract_start_date || wizardData.deposit_amount) {
        try {
          ...
          console.error('âš ï¸ Error guardando informaciÃ³n del contrato:', contractError);
        }
      }
      ...
      if (wizardData.assigned_property_ids && wizardData.assigned_property_ids.length > 0) {
        try {
          ...
          console.log(`âœ… ${wizardData.assigned_property_ids.length} propiedades asignadas`);
        } catch (propError) {
          console.error('âš ï¸ Error asignando propiedades:', propError);
        }
      }
      ...
      alert('âœ… Cliente creado exitosamente con todos sus datos!');

    } catch (error) {
      console.error('âŒ Error en handleWizardSubmit:', error);
      alert('Error al crear el cliente. Por favor, revisa la consola para mÃ¡s detalles.');
    }
  };
  ...
  return (
    <div className="p-6">
            ...
            <div className="p-4 space-y-3">
              <div className="grid grid-cols-1 gap-2">
                ...
                <div className="flex items-center gap-3 text-sm">
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-xs text-gray-500 dark:text-gray-400">TelÃ©fono</p>
                ...
                {(client.city || client.address) && (
                  <div className="flex items-center gap-3 text-sm">
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="text-xs text-gray-500 dark:text-gray-400">UbicaciÃ³n</p>
                ...
                {(client.occupation || client.company_name) && (
                  <div className="flex items-center gap-3 text-sm">
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="text-xs text-gray-500 dark:text-gray-400">ProfesiÃ³n</p>
                      <p className="text-gray-900 dark:text-white truncate">
                        {client.occupation || client.company_name}
                      </p>
                    </div>
              ...
              {/* InformaciÃ³n financiera (si existe) */}
      ...
      {/* ========================================
          ...
          Reemplazados por:
          - ClientDetailsEnhanced (ver mÃ¡s abajo)
          - ClientEditForm (ver mÃ¡s abajo)
          ======================================== */}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="space-y-6">
                ...
                <div className="bg-gray-50 dark:bg-gray-800 rounded-xl p-6">
                  <div className="text-center mb-4">
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400">
                      CÃ³digo: {selectedPropertyForDetails.code}
                    </p>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="text-center p-3 bg-white dark:bg-gray-700 rounded-lg">
                      ...
                      <p className="text-lg font-bold text-gray-900 dark:text-white">{selectedPropertyForDetails.area}mÂ²</p>
                    </div>
                    <div className="text-center p-3 bg-white dark:bg-gray-700 rounded-lg">
                ...
                {selectedPropertyForDetails.description && (
                  <div className="bg-gray-50 dark:bg-gray-800 rounded-xl p-6">
                    <h4 className="font-semibold text-gray-900 dark:text-white mb-3">DescripciÃ³n</h4>
