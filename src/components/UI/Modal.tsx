      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-2 sm:p-4">
          ...
          <motion.div
            ...
            className={`relative bg-white dark:bg-gray-800 rounded-2xl shadow-2xl border border-gray-200 dark:border-gray-700 w-full ${sizes[size]} max-h-[90vh] overflow-hidden ${className}`}
          >
            {/* Header */}
