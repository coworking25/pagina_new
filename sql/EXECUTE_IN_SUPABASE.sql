-- =====================================================
-- SISTEMA DE GESTIÓN DE CLIENTES - EJECUTAR EN SUPABASE
...
-- =====================================================
-- PASO 2: CREAR TABLA CLIENTS (Principal)
-- =====================================================
CREATE TABLE clients (
    ...
    assigned_advisor_id UUID, -- Referencias advisors(id) - lo agregamos después
    notes TEXT,
...
-- =====================================================
-- PASO 3: CREAR TABLA CONTRACTS (Contratos)
-- =====================================================
CREATE TABLE contracts (
    ...
    property_id UUID, -- Referencias properties(id) - lo agregamos después
    landlord_id UUID REFERENCES clients(id), -- Solo si client es tenant
...
-- =====================================================
-- PASO 4: CREAR TABLA PAYMENTS (Pagos)
-- =====================================================
...
-- =====================================================
-- PASO 5: CREAR TABLA CLIENT_COMMUNICATIONS
-- =====================================================
CREATE TABLE client_communications (
    ...
    -- Referencias
    client_id UUID NOT NULL REFERENCES clients(id) ON DELETE CASCADE,
    advisor_id UUID, -- Referencias advisors(id) - lo agregamos después
...
-- =====================================================
-- PASO 6: CREAR TABLA CLIENT_DOCUMENTS
-- =====================================================
CREATE TABLE client_documents (
    ...
    -- Metadatos
    uploaded_by UUID, -- Referencias advisors(id) - lo agregamos después
    notes TEXT,
    created_at TIMESTAMP WITH TIME ZONE DEFAULT NOW(),
    updated_at TIMESTAMP WITH TIME ZONE DEFAULT NOW()
);
...
-- =====================================================
-- PASO 7: CREAR TABLA CLIENT_ALERTS
-- =====================================================
CREATE TABLE client_alerts (
    ...
    resolved_by UUID, -- Referencias advisors(id) - lo agregamos después
...
-- =====================================================
-- PASO 10: CREAR TRIGGERS PARA UPDATED_AT
-- =====================================================
...
-- =====================================================
-- PASO 11: CREAR FUNCIÓN PARA ALERTAS DE PAGOS VENCIDOS
-- =====================================================
...
-- =====================================================
-- PASO 12: CREAR TRIGGER PARA PAGOS VENCIDOS
-- =====================================================
...
-- =====================================================
-- PASO 13: CREAR FUNCIÓN PARA ALERTAS DE CONTRATOS
-- =====================================================
...
-- =====================================================
-- PASO 14: CREAR TRIGGER PARA CONTRATOS POR VENCER
-- =====================================================
...
-- =====================================================
-- PASO 15: CREAR FUNCIÓN PARA GENERAR PAGOS AUTOMÁTICOS
-- =====================================================
...
BEGIN
    ...
    FOR i IN 1..p_months_ahead LOOP
        -- Calcular fechas
        period_start := DATE_TRUNC('month', CURRENT_DATE) + (i-1) * INTERVAL '1 month';
        period_end := period_start + INTERVAL '1 month' - INTERVAL '1 day';
        payment_date := DATE_TRUNC('month', period_start) + (contract_record.payment_day - 1) * INTERVAL '1 day';
        ...
        IF NOT EXISTS (
            ...
            AND payments.period_start = period_start
        ) THEN
            -- Crear el pago
...
-- =====================================================
-- PASO 17: INSERTAR DATOS DE EJEMPLO (OPCIONAL)
-- =====================================================
...
-- =====================================================
-- PASO 18: GENERAR PAGOS PARA EL CONTRATO DE EJEMPLO
-- =====================================================
...
-- =====================================================
-- PASO 19: VERIFICAR LA INSTALACIÓN
-- =====================================================
...
-- ✅ 6 tablas principales del sistema de clientes
-- ✅ Todos los índices para optimización
-- ✅ Triggers automáticos para timestamps y alertas
-- ✅ Funciones útiles para generar pagos
