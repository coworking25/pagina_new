-- =====================================================
-- FIX AUDIT LOG - PASO 3: ACTUALIZAR FUNCIONES
-- =====================================================
-- Ejecuta este paso después del Paso 2

-- Función mejorada que verifica si el usuario es asesor
...
BEGIN
  ...
  -- ✅ NUEVO: Verificar si el usuario es un asesor
...
SELECT '✅ Paso 3 completado: Funciones actualizadas' as status;
